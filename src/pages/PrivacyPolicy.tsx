...
const PrivacyPolicy: React.FC = () => {
  return (
    <div className="min-h-screen bg-[#030203]">
      <header className="bg-[#DFE742] text-black py-4 px-8 text-center">
      ...
      <main className="p-8 bg-white mx-auto my-8 max-w-4xl rounded-lg shadow-md">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">This summary provides key points from our Privacy Notice.</p>
          <ul className="list-disc pl-6 space-y-2">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4"><strong>Personal information you disclose to us:</strong> In Short: We collect personal information that you provide to us.</p>
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li><strong>Mobile Device Access:</strong> We may request access or permission to certain features from your mobile device, including your mobile device's camera, microphone, and other features. If you wish to change our access or permissions, you may do so in your device's settings.</li>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold mb-4">Information Automatically Collected</h2>
          <p className="mb-4">In Short: Some information — such as your Internet Protocol (IP) address and/or browser and device characteristics — is collected automatically when you visit our Services.</p>
          <p className="mb-4">We automatically collect certain information when you visit, use, or navigate the Services. This information does not reveal your specific identity (like your name or contact information) but may include device and usage information, such as your IP address, browser and device characteristics, operating system, language preferences, referring URLs, device name, country, location, information about how and when you use our Services, and other technical information. This information is primarily needed to maintain the security and operation of our Services, and for our internal analytics and reporting purposes.</p>
          <p className="mb-4"><strong>The information we collect includes:</strong></p>
          <ul className="list-disc pl-6 space-y-2">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">In Short: We process your information to provide, improve, and administer our Services, communicate with you, for security and fraud prevention, and to comply with law. We may also process your information for other purposes with your consent.</p>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">In Short: We may share information in specific situations described in this section and/or with the following categories of third parties.</p>
          <p className="mb-4">Vendors, Consultants, and Other Third-Party Service Providers: We may share your data with third-party vendors, service providers, contractors, or agents ("third parties") who perform services for us or on our behalf and require access to such information to do that work.</p>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">We may use cookies and similar tracking technologies (like web beacons and pixels) to gather information when you interact with our Services.</p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">In Short: We aim to protect your personal information through a system of organizational and technical security measures.</p>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">We do not knowingly collect, solicit data from, or market to children under 18 years of age.</p>
        </section>

        <section className="mb-8">
          <h2 className="text-2xl font-bold mb-4">9. Controls for Do-Not-Track Features</h2>
          <p className="mb-4">Most web browsers and some mobile operating systems and mobile applications include a Do-Not-Track ("DNT") feature or setting you can activate to signal your privacy preference not to have data about your online browsing activities monitored and collected.</p>
        </section>

        <section className="mb-8">
          <h2 className="text-2xl font-bold mb-4">10. Do We Make Updates to This Notice?</h2>
        ...
        <section className="mb-8">
          ...
          <p className="whitespace-pre-line">
            Plunge Technologies Private Limited
            House No. 42, terrace floor, Sainik Vihar
            Pitampura, New Delhi- 110034
          </p>
        </section>
      </main>

      <footer className="bg-[#DFE742] text-black py-4 px-8 text-center">
